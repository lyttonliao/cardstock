  ...
  return (
    <nav className="border-b border-border bg-app sticky top-0 z-10 px-6 py-[14px]">
      <div className="max-w-[1280px] mx-auto flex items-center gap-8">
        {/* Logo */}
        <Link href="/cards" className="flex items-center gap-2.5 no-underline">
        ...
        {/* Nav links */}
        <Link href="/cards" className="text-[13px] text-fg-3 hover:text-fg-1 no-underline transition-colors">Cards</Link>
