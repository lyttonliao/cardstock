...
export default function HomePage() {
  return (
    <div>
      {/* Full-width banner */}
      <div className="w-screen relative left-1/2 -translate-x-1/2 animate-pulse [animation-duration:4s] -mt-8 h-[450px]">
        <Image src="/Pulse.png" alt="banner" fill className="object-cover" priority />
      </div>

      {/* Hero */}
      <div className="relative py-28 flex flex-col items-center text-center overflow-hidden">
        <div className="relative z-10 flex flex-col items-center justify-center gap-5 max-w-xl">
          ...
          <h1 className="text-5xl font-display font-bold text-fg-1 leading-tight tracking-tight">
